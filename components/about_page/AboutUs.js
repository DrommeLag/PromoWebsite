    ...
    return (
        ...
        <div className="qs">
            <div className="text-q">
                <h1 className="h-text">Що ти отримуєш ?</h1>
                <span id="line"><img alt="line" src='images/main_page/line_score.svg'/></span>
                <p className="p_landing_about" id="q-p">Вся країна у твоєму телефоні. Єдиний в Україні додаток, з подібним функціоналом, зручний інтерфейс та інтерактивність. </p>
            </div>
        ...
        <div className="qs">
            ...
            <div className="text-q">
                <h1 className="h-text">Чому ми ?</h1>
                <span id="line"><img alt="line" src='images/main_page/line_score.svg'/></span>
                <p className="p_landing_about" id="q-p">Ми команда студентів програми Internet of Things із Lviv Polytechnic National University.
        ...
        <div id="team-text">
            <h1 className="h-text">Команда розробників</h1>
            <span id="line"><img alt="line" src='images/main_page/line_score.svg'/></span>
        </div>
        <div className="team">
        ...
        <div className="cooperation">
            <h1 className="h-text">Хочеш співпрацювати?</h1>
            <p className="p_landing_about" id="coop-p">Ми відкриті до рекламних пропозицій від українських брендів, для розміщення продуктів на нашому маркетплейсі. </p>
            <div id="coop-btn">
        ...
        <div className="ask_form">
            <h1 className="h-text">Маєш якісь запитання?</h1>
            <span id="line"><img alt="line" src='images/main_page/line_score.svg'/></span>
        ...
        <div className="QandA">
            ...
            <div className="blue-boxes">
                <div className="box">
                    ...
                    <p className="p_landing_about" id="box-answer">Так, кожен може користуватись додатком просто скачавши його.</p>
                </div>
                <div className="box">
